...
public class Kategori1941723005Fikrul {
    ...
    public ArrayList<Kategori1941723005Fikrul> getByNamaAndKeteranganFikrul(String nama, String keterangan) {
        ArrayList<Kategori1941723005Fikrul> ListKategori = new ArrayList();
        ResultSet rs;
        if ((nama.trim().length() > 0) && (keterangan.trim().length() > 0)) {
            rs = DBHelper1941723005Fikrul.selectQueryFikrul("SELECT * FROM kategori WHERE nama = '" + nama + "' and keterangan = '" + keterangan + "'");
            ...
            rs = DBHelper1941723005Fikrul.selectQueryFikrul("SELECT * FROM kategori WHERE keterangan = '" + keterangan + "'");
        }
        try {
            while (rs.next()) {
                Kategori1941723005Fikrul kat = new Kategori1941723005Fikrul();
